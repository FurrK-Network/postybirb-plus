...
import CustomE621Login from './customE621Login';
import { customE621TagSearchProvider } from './providers';

// eslint-disable-next-line @typescript-eslint/class-name-casing
export class CustomE621 extends WebsiteImpl {
  internalName: string = 'CustomE621';
  name: string = 'CustomE621';
  supportsAdditionalFiles: boolean = false;
  supportsTags: boolean = true;
  loginUrl: string = '';

  LoginDialog = (props: LoginDialogProps) => <CustomE621Login {...props} />;
  ...
  FileSubmissionForm = (props: SubmissionSectionProps<FileSubmission, e621FileOptions>) => (
    <E621FileSubmissionForm
      ...
      tagOptions={{
        show: true,
        searchProvider: customE621TagSearchProvider,
      }}
      ratingOptions={{
        show: true,
        ratings: [
