...
export default class CustomE621Login extends React.Component<LoginDialogProps, State> {
  state: State = {
    username: '',
    key: '',
    sending: false,
  ...
  submit() {
    if (this.state.key && this.state.username) {
      ...
      Axios.get<any>(
        `${getBaseE621Url()}/posts.json?login=${encodeURIComponent(data.username)}&api_key=${
          data.key
        }&limit=1`,
        {
          responseType: 'json',
      ...
      <div className="container mt-6">
        <Form layout="vertical">
          ...
          <Form.Item
            ...
            extra={
              <div>
                <BrowserLink url={`${getBaseE621Url()}/users/home`}>
